...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default items-center gap-1.5 px-3 py-2 text-sm outline-none select-none",
        "first:rounded-t-lg last:rounded-b-lg",
        "bg-slate-50 focus:bg-slate-200",
