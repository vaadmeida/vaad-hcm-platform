...
documentRouter.get('/types', authenticate, requireRoles('admin', 'hr'), asyncHandler(getDocumentTypesController))
...
documentRouter.post('/employee/:employeeId', authenticate, requireRoles("admin", "hr"), upload.single('file'), asyncHandler(uploadEmployeeDocumentController))
